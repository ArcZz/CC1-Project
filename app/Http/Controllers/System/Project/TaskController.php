...
//
//        return view('system/project/publication',['article' => $msg, 'type' => 'Article', 'number' => '1']);
//    }
    ...
    public function jupyterRecNotebook() {
        $url = 'http://ec2-3-83-127-51.compute-1.amazonaws.com/api/rec/jupyter?keyword=' . $_GET['jupInput'];
